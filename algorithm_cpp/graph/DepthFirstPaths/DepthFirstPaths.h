#ifndef _H_DEPTHFIRSTPATHS
#define _H_DEPTHFIRSTPATHS 1
...
public:
    ...
    virtual void dfs(int v);                // 从顶点v开始执行深度优先遍历
...
public:
    DepthFirstPaths(BaseGraph &graph, int v);   // 利用深度优先遍历得到结点v到每个其它结点的路径
    void dfs(int v);                            // 从顶点v开始执行深度优先遍历
